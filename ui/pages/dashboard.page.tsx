    ...
    <div className={styles.allWrapper}>
        ...
        <div onClick={closeCreateChat} className={styles.createChatOuterWrapper} >
          <div className={styles.createChatWrapper} >
            <div className={styles.createChatHeaderWrapper} >
              ...
              <div className={styles.createChatCloseButton} onClick={closeCreateChat} >
            ...
            <div className={styles.createChatContentWrapper} >
              ...
              <span className={styles.eachInputDescription} >Enter the Mina public key of each participant. You may not add or remove a participant from the chat once you create it. All users will be totally anonymous.</span>
              <span className={styles.eachInputDescription} >You will automatically be added to the chat, no need to add yourself.</span>
      ...
      <div className={styles.navbarWrapper} >
        <div className={styles.navbarHeader} >
          ...
          <div className={styles.navbarHeaderButtonsWrapper} >
            <button className={styles.joinChatButton} >Join Chat</button>
              ...
              return (
                <div className={styles.eachMessageOuterWrapper} key={i}>
                  <div className={styles.eachMessageWrapper} >
                    {i == 0 || messages[i-1].username != message.username ? <span className={styles.eachMessageUsername} >{message.username}</span> : <div></div>
                    }
